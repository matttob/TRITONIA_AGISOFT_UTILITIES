...
for chunk in Metashape.app.document.chunks:
    ...
    print("Percentage of total points removed based on Reconstruction Uncertainty = " + str((percent_selecteds_less_than_half[rep_cunc_half_points_selected_ind])*100) + "%")